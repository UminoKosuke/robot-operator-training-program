...
コマンド実行後、以下の1から2まで進め初期姿勢をとり、その後recoding episodeという音声が聞こえたら、3から16までに沿ってPick and Placeを進める

1. 初期姿勢をとる。[./init-pose.md](./init-pose.md)を参照。
2. タスクを実行する。[./task.md](./task.md)を参照。
3. 完了姿勢をとる。[./final-pose.md](./final-pose.md)を参照。
